...
function displayMname(){
	   ...
	   var namOffilm=document.form1.movie.options[document.form1.movie.selectedIndex].value;
	     ...
	     if(namOffilm=="Don 2"){
	   document.getElementById("poster").src="images/poster/don.jpg";
	   }
	   if (namOffilm=="Sultan"){
			document.getElementById("poster").src="images/poster/sultan.jpg";
	   }
	   if(namOffilm=="Rockstar"){
	   document.getElementById("poster").src="images/poster/rockstar.jpg";
	   }
